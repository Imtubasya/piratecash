...
"user-agent:Mozilla/5.0 (Linux; Android 9; Mi A1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Mobile Safari/537.36",
"referer:https://piratecash.io/login.php",
...
$urljp="https://piratecash.io/a_jackpot_updater.php?jackpotid=66";
	get($urljp, $get);
$urlsp="https://piratecash.io/a_whee12k.php";
$datasp="jd=".$jd."&txmm=2";
$spiner=post($urlsp, $post, $datasp);
	$g = explode( '<font color="red">Cheating/auto spin report generated: <b>' , $spiner);
        $h = explode( '</b> is marked and will be banned. Withdrawal disabled.</font>' ,  $g[1]);
$spn=$plus."CHECK : ".$hijau2.$h[0]; echo $spn;
...
$clik=mt_rand(1, 5);
$clik1=mt_rand(1, 4);
$dataat="jd=".$jd."&tileclick=".$clik."&cashout=1";
$datasc="jd=".$jd;

$sc=post($urlsc, $post, $datasc); get($urljp, $get);
